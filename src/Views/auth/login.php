        ...
        <form method="POST" action="" class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    <i class="fas fa-user mr-1 text-blue-500"></i>Email или телефон
                </label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    <i class="fas fa-robot mr-1 text-blue-500"></i>Проверка безопасности
                </label>
                <div id="captcha-container" 
                     class="smart-captcha" 
                     data-sitekey="<?php echo Config::CAPTCHA_CLIENT_KEY; ?>">
                </div>
            </div>
